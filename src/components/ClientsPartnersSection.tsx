        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-4">
              We majorly work with businesses in <strong className="text-foreground">Real Estate, SaaS, and Fintech</strong> — along with clients across Ecommerce, EdTech, and Travel — helping them achieve measurable growth through Google Ads, Meta Ads, and AI-powered SEO.
            </p>
