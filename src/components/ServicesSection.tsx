...
import { ArrowRight, BarChart3, Target, TrendingUp, Users, Zap, LineChart, MousePointerClick, Search, Code, Layout } from "lucide-react";
...
const services = [
  ...
  {
    icon: <Layout size={32} />,
    title: "CRO & Web Design",
    subtitle: "Websites, Landing Pages & Conversion Optimization",
    description: "We design conversion-focused websites and landing pages that turn traffic into leads. Every pixel is optimized for user experience, speed, and maximum conversions.",
    features: ["High-Converting Landing Pages", "WordPress & Custom Web Development", "A/B Testing & Heatmaps", "UI/UX Optimization", "Speed & Mobile Optimization"],
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-bold mt-3 mb-5">
            Ads. Design. <span className="text-gradient">Conversions.</span>
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Meta Ads, Google Ads, and conversion-focused web design — backed by deep performance marketing expertise.
          </p>
        </motion.div>
